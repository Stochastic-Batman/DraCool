...
``docs/DraCool.pdf`` derives the ray-casting criterion that lets the client
...
from dracool.cities import CITIES, City, all_cities, get_city
from dracool.constants import CONSTANTS, Constants, load_constants
